...
ProtonCTInteractionParameters::ProtonCTInteractionParameters(G4bool wantMessenger): 
...
{
    if (wantMessenger) pMessenger = new ProtonCTParameterMessenger(this); 
}

ProtonCTInteractionParameters::~ProtonCTInteractionParameters()
{
...
G4double ProtonCTInteractionParameters::GetStopping (G4double ene, 
...
bool ProtonCTInteractionParameters::GetStoppingTable(const G4String& vararg)
{
	// Check arguments
...
G4Material* ProtonCTInteractionParameters::GetNistMaterial(G4String mat)
{
...
bool ProtonCTInteractionParameters::ParseArg(const G4String& vararg)
{
...
void ProtonCTInteractionParameters::BeamOn()
{
...
void ProtonCTInteractionParameters::ListOfNistMaterials(const G4String& vararg)
{
/*
